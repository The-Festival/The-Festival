...
<html lang="en">
  ...
  <div class="col d-flex flex-row-reverse">
        ...
        <button type = "button" onclick = "window.location.href = '/admin/exportorder'" class = "btn btn-warning">Export CSV</button>
        </div>
  </div>
</div>
            ...
            <?php foreach($orders as $order): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/admin/orderpdf?id=<?php echo $order->getOrderId(); ?>" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
