...
<html lang="en">
  ...
  <body>
    <h1 class = "d-flex justify-content-center">Add yummy ticket to order : <?php echo $order_id ?></h1>
        ...
        <div class = "row">
            <div class = "col-12">
                <form action = "/admin/ticketdashboard" method = "post">
                    <input type="hidden" name  = "addYummyTicketToOrder">
                    <input type="hidden" name="order_id" value="<?php echo $order_id ?>">
                    <div class = "form-group">
                        <label for = "event_id">Reservation :</label>
                    <select name="event_id" class = "form-select" Required>
                        <?php foreach($yummyEvents as $event){?>
                            <option value="<?php echo $event['reservation_id']?>">ID : <?php echo $event['reservation_id']?> Naam: <?php echo $event['name']?></option>
                            <?
                            }
                            ?>
                    </select>
                    ...
                    <div class = "form-group">
                        ...
                        <button type = "submit" class = "btn btn-primary mt-2">Add Yummy Ticket</button>
                    </div>
