...
--
INSERT INTO
  `Api_Token` (`token_id`, `token`, `company_name`)
VALUES
  (
    1,
    'D95DD537-0969-485B-8DCA-5889EC11FB35',
    'JAN PIET BV.'
  ),
  (
    2,
    '8481AB3B-B39D-4D6B-A932-2CBF4567F0D5',
    'Inholland'
  );
...
--
INSERT INTO
  `Artist` (`artist_id`, `name`, `about`)
VALUES
  (
    1,
    'Gumbo Kings',
    'The Gumbo Kings are a five-piece band who combine the groove of New Orleans with rugged delta blues and the melody of soul from old Memphis. The band is their love baby, and their aim is to convey their passion for music through an energetic live show.'
  ),
  (
    2,
    'Evolve',
  ...
  (
    3,
    'Ntjam Rosie',
    'Ntjam Rosie, born as Rosie Boei, is a Dutch-Cameroonian singer/songwriter from Rotterdam, The Netherlands. Her style is a mix of pop music, jazz and soul.'
  ),
  (
    4,
    'Wicked Jazz Sounds',
    'Wicked Jazz Sounds is a versatile music platform that connects the sensations of jazz with the energy of contemporary dance music.Wicked Jazz Sounds is a versatile music platform that connects the sensations of jazz with the energy of contemporary dance music. Wicked Jazz Sounds is a versatile music platform that connects the sensations of jazz with the energy of contemporary dance music.'
  ),
  (
    5,
  ...
  (
    6,
    'Jonna Frazer',
    'Jonna Fraser is a rapper and singer, but above all a particularly driven performer. The Rotterdam-born storyteller has been living in Zaandam for more than half his life. At age 11, he was introduced to rap and then never let go of the microphone.'
  ),
  (
    7,
    'Fox & The Mayors',
  ...
  (
    8,
    'Uncle Sue',
    'Uncle Sue is a seven-piece Haarlem Funk and Soul Band with its own story, soul diva and swinging horn section. Quirky repertoire, from their own studio and slightly less obvious gems by our musical heroes. A sound that harks back to the 60s and 70s. That\'s where Uncle Sue feels at home'
  ),
  (
    9,
    'Chris Allen',
  ...
  (
    13,
    'Gare du Nord',
    'Gare du Nord is a Dutch-Belgian jazz band, originally consisting of Doc and Inca. Doc played guitar and Inca played saxophone, while both performed vocal duties. After the pair split up in 2013, the band continued to work and tour with a different line-up'
  ),
  (
    14,
    'Rilan & The Bombadiers',
    'With a sold out first clubtour, a booming festival season and tracks that have already been featured in a number of big Hollywood productions, (Netflix / HULU / FOX: Shooter, Shut Eye and Rosewood) this band has certainly been keeping busy. Both nationally and abroad.'
  ),
  (
    15,
    'Soul Six',
...
VALUES
  ...
  -- The Nordanians, Gumbo Kings, Gare du Nord
  (
    22,
    17,
    'Grote Markt',
...
VALUES
  ...
  (
    ...
    10,
    'test event',
    '/img/6425e64037baa9.55377270.png',
    0
  ),
  (
    15,
    11,
    'Thijs Moerland',
    '/img/6426bdd6cd2f58.62065506.png',
    0
  ),
  (
    16,
    11,
    'Thijs Moerland',
    '/img/6426cfad6b29f8.97681321.png',
    0
  ),
  (
    17,
    12,
    'Thijs Moerland',
    '/img/6426d0be9ecf22.57803827.png',
    0
  ),
  (
    19,
  ...
  (
    ...
    2,
    'Amsterdamse Poort',
    '/img/642c27e93c4613.57325875.png',
    0
  ),
  (
    21,
    2,
    'Amsterdamse Poort',
    '/img/642c2a42cf0818.88290339.png',
    0
  );
...
--
INSERT INTO
  `Tour` (`tour_id`, `datetime`, `start_location`, `price`)
VALUES
  (
    1,
    '2023-03-21 14:30:00',
...
VALUES
  (
    ...
    'Mutti',
    'mutti123@gmail.com',
    '$2y$10$U2C8GzuGPEkNs5BF0TvQMu1rtGuBlMoMWBqzZoXzfXBJNVH.0Hjry',
    'customer',
    '2023-03-01'
  ),
  (
  ...
  (
    6,
    'Usman',
    'muttalip9801@gmail.com',
    '$2y$10$3a5G7f6I7Z6/XWJXLG.mrerYugDEi0DTTcK62SbBmZ/brLgRr2Pn6',
    'customer',
    '2023-03-14'
  ),
  (
    ...
    'Thijs Moerland',
    'Moerland8@gmail.com',
    '$2y$10$/hl0X1lVbEwtbuT5LwAtIuB.KjZHKK7k8gjD5ONsZY7oqp4JGbzii',
    'customer',
    '2023-03-15'
  ),
  (
    ...
    'henk',
    'henk@gmail.com',
    '$2y$10$SOk.60rek5ngz8K4ML.6T.aDppi62BvIUf6sduxAzow6kZ0dQrdiy',
    'customer',
    '2023-03-20'
  ),
  (
    ...
    'luke',
    'Luke@gmail.com',
    '$2y$10$B6juEdgRXRc49wAN6MdR3O9stnv2nUwVDYi4BZ/T27QxelERBrrji',
    'customer',
    '2023-03-31'
  ),
  (
    ...
    'Mark',
    'mark@gmail.com',
    '$2y$10$XRMIfWEAxNi9DzyH04vYB.EBdBsoTUOMR2jx6Pdik4DdGWPQs0fyO',
    'admin',
    '2023-04-25'
  ),
  (
    ...
    'Usman',
    'muttalip9801@gmail.com',
    '$2y$10$ImVOnTNZ5h.I49eYyb3TfOd3.UBBhMtBXt2Bxdt30lMjeXWtQyyrW',
    'admin',
    '2023-04-25'
  );
...
ADD
  KEY `FK_language_tour_id` (`tour_id`);
...
ADD
  KEY `FK_ticket_order_orderId` (`order_id`);
...
ALTER TABLE
  `Guide`
ADD
  CONSTRAINT `Guide_ibfk_1` FOREIGN KEY (`tour_id`) REFERENCES `Tour` (`tour_id`);
...
ALTER TABLE
  `Language`
ADD
  CONSTRAINT `FK_language_tour_id` FOREIGN KEY (`tour_id`) REFERENCES `Tour` (`tour_id`);
...
ALTER TABLE
  `Reservation`
ADD
  CONSTRAINT `Reservation_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `Session` (`session_id`),
ADD
...
ALTER TABLE
  `Ticket`
ADD
  CONSTRAINT `FK_ticket_order_orderId` FOREIGN KEY (`order_id`) REFERENCES `Order` (`order_id`);
